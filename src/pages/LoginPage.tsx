    ...
    <div className="min-h-screen bg-background flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-text-primary">Winbro Training Reels</h1>
            ...
            <div className="mt-6">
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-divider-subtle" />
                </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <Button variant="outline" className="w-full">
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.64 7.2c-.3-1.1-1.2-1.9-2.3-2.2C19.4 4.5 12 4.5 12 4.5s-7.4 0-9.3.5c-1.1.3-2 1.1-2.3 2.2C0 9.1 0 12 0 12s0 2.9.4 4.8c.3 1.1 1.2 1.9 2.3 2.2 1.9.5 9.3.5 9.3.5s7.4 0 9.3-.5c1.1-.3 2-1.1 2.3-2.2.4-1.9.4-4.8.4-4.8s0-2.9-.4-4.8zM9.5 15.1V8.9l6.2 3.1-6.2 3.1z"/>
                  </svg>
                  Microsoft
                </Button>
              </div>
